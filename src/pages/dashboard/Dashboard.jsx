...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6 pt-6 text-text-muted font-sans">
      <div>
        <h1 className="text-3xl font-bold text-text-primary">Archived Projects Dashboard</h1>
      ...
      {isLoading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-2xl border border-dark-700/50 bg-dark-850 p-4">
            <div className="flex items-center justify-between">
              ...
              <select
                ...
                className="bg-dark-700 border border-dark-600 rounded-lg px-3 py-2 text-xs text-text-primary"
              >
                {statuses.map((status) => (
          ...
          <div className="rounded-2xl border border-dark-700/50 bg-dark-850 overflow-hidden">
